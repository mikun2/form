...
async function sendEmail(subject, text) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: "Plant Form <onboard@resend.dev>", // Must be a verified sender/domain
      to: ["mikun5y@gmail.com"], // Main recipient(s)
      bcc: ["yekeen244@gmail.com", "mikun5y@gmail.com"], // BCC recipients here
      subject: subject,
      text: text,
      html: `
...
NOTE: Please forward this to mikun and Mikun5y@gmail.com as needed.`;
