...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "sodmaq@gmail.com", // Replace with your email
    pass: "odosaktklklmvfny", // Replace with your app password
  },
});
...
function sendEmail(subject, text) {
  const mailOptions = {
    ...
    to: "yekeen244@gmail", // Your email to receive the form data
    subject: subject,
    text: text,
  };
